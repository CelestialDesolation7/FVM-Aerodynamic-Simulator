...
用户选择新色图
  ↓
generateXXXColormap: CPU生成256×3 RGB数据
  ↓
glTexImage1D: CPU→GPU上传3KB
```
...
step=20，约1300个箭头
  ↓
CPU生成顶点：1300箭头 × 6顶点 × 5float = 156KB
  ↓
glBufferData上传：156KB
  ↓
glDrawArrays绘制：7800个顶点
```
